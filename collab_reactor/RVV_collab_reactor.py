...
class NewBallReactor(paramak.Reactor):
    ...
    def _make_vacuum_vessel(self):
        ...
        self._mid_ports = paramak.PortCutterRectangular(
            distance = self._vacuum_vessel_end_radius*10,
            height = 100,
            width = 100,
        ...
        self._vacuum_vessel = paramak.VacuumVesselInnerLeg(
            inner_radius = ((self._vacuum_vessel_end_radius - self._vacuum_vessel_start_radius))-self.vacuum_vessel_thickness,
            thickness = self.vacuum_vessel_thickness,
            inner_height = self._vacuum_vessel_height-self.vacuum_vessel_thickness,
            inner_leg_radius = self._vacuum_vessel_start_radius,
